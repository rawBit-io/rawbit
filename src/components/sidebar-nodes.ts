...
export const allSidebarNodes: NodeTemplate[] = [
  ...
  },
  {
    ...
    label: "Radio Send",
    category: "Canvas & Inputs",
    subcategory: "Wireless Links",
    description:
      "Publish a value to a numbered wireless link. Pair by channel number, e.g. 1.",
    type: "radioNode",
    nodeData: {
      functionName: "radio_send",
      title: "Radio Send 1",
  ...
  },
  {
    ...
    subcategory: "Wireless Links",
    description:
      "Receive a value from the matching Radio Send with the same channel number.",
    type: "radioNode",
    nodeData: {
      functionName: "radio_receive",
