...
export const customFlows: CustomFlowTemplate[] = [
  ...
  {
    id: "flow-10-segwit-multi-input",
    label: "SegWit Multi-Input Signing",
    data: segwitMultiInput as unknown as FlowData,
    section: "segwit",
    flowNo: 10,
    level: "intermediate",
    tags: ["segwit", "p2wpkh", "bip143", "multi-input", "signing"],
  },
  {
    id: "flow-11-segwit-p2wsh-inheritance",
    label: "SegWit P2WSH",
    data: p2wshInheritance as unknown as FlowData,
    section: "segwit",
    flowNo: 11,
    level: "intermediate",
  ...
  },
  {
    ...
    data: spilmanPaymentChannel as unknown as FlowData,
